...
## Post-selection survey (deadline: April 28, 2023)

Participants who have been notified of acceptance to the workshop will need to
complete the post-selection survey.

Before taking the survey, please [register for GitHub](https://github.com/join)
if you do not already have an account. One of the survey questions asks for your
GitHub username.
...
## 🐙 Post an introduction to GitHub Discussions (deadline: May 16, 2023)
...
## ❄️ CryoCloud account (deadline: May 16, 2023)
...
## 💾 Select a dataset of interest (deadline: May 16, 2023)
