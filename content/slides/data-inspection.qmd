...
* Broadly supported by common software tools
...
# Geospatial data formats: CSV/TSV
...
# Geospatial data formats: Microsoft .xls/.xlsx
...
::: {.notes}
[The display of stored numbers as integers or currency is through display format options.](https://www.loc.gov/preservation/digital/formats/fdd/fdd000398.shtml)
:::

# Geospatial data formats: [ESRI Shapefile](https://www.loc.gov/preservation/digital/formats/fdd/fdd000280.shtml#factors)
...
# Geospatial data formats: [NetCDF](https://www.unidata.ucar.edu/software/netcdf/)

* Raster (and vector) data
* Extension of [HDF](https://www.loc.gov/preservation/digital/formats/fdd/fdd000229.shtml) 🌎
* Self-Describing
...
# Geospatial data formats: GeoPackage
...
::: {.notes}
* ASCII Grids are used to store raster data in a ASCII text format.

* World Files are text files that accompany other raster data file (e.g., `jpeg`,
`png`) and provide geospatial metadata.

* ESRI GeoDatabases are proprietary.
:::
...
does not reflect the quality of the original dataset._

```{.text code-line-numbers="1|2-3|4|10-14"}
$ gdalinfo content/examples/data-scenarios/01-missing-metadata/bamber_greenland_dem.tif 
Driver: GTiff/GeoTIFF
Files: bamber_greenland_dem.tif
Size is 301, 561
Metadata:
...
```
$ rio info --crs bamber_greenland_dem.tif 
