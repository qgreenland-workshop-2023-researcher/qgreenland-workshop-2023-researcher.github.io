...
## Raster with no metadata

_TODO: Show what it looks like to inspect this file with one of the above methods_

`/content/exercises/data-scenarios/01-missing-metadata/bamber_greenland_dem.tif`
