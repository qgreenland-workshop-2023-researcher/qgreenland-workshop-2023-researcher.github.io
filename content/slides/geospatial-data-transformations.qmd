...
::: {.notes}
* Review the scenario on the website
* Point out the ambiguity of the scenario is typical of a real
  collaboration
* If anyone asks about interpolation done on plot outputs, point out that
  `imshow` can take `interpolation='nearest'` argument.
:::
