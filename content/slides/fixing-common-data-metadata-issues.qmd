...
```
```{.console code-line-numbers="|4-41|43,51-52|44"}
Driver: GTiff/GeoTIFF
...
```
```{.console code-line-numbers="|4|5,9-10|7-8"}
...
```
```{.console code-line-numbers="|4|5-7|8-22"}
...
```
```{.console code-line-numbers="|4-40|42,48-49"}
Driver: GTiff/GeoTIFF
Files: datafile.tif
Size is 2813, 1914
Coordinate System is:
...
[Link](/content/exercises/data-scenarios/raster-missing-nodata-value)
...
## Raster missing NoData value: Solution
...
## Raster missing NoData value: All better!
