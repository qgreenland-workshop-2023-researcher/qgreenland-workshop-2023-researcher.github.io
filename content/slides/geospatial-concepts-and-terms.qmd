...
:::{.notes}
* Rasters can sometimes contain a mix of continous and categorical data (a
...
* The symbology of raster data may be categorical while the underlying data is
  continous (e.g., high/medium/low sea ice concentration).
:::
...
::: {.notes}
When a dataset follows of one or more common standards, GIS practitioners and tools can
accurately parse information about CRS, date/time, etc.
:::


## Tools for inspecting metadata
